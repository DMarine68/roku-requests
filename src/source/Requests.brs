...
function Requests_request(method, url as String, args as Object)
    ...
    if args <> invalid and type(args) = "roAssociativeArray"
        ...
        if args.retryCount <> invalid and (type(args.retryCount) = "Integer" or type(args.retryCount) = "roInteger" or type(args.timeout) = "roInt")
        ...
        if args.cacheSeconds <> invalid and (type(args.cacheSeconds) = "Integer" or type(args.cacheSeconds) = "roInteger" or type(args.timeout) = "roInt")
